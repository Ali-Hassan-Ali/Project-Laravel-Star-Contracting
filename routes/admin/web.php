...
Route::middleware([
    ...
    ->group(function () {
        ...
        Route::name('admin.')->prefix('admin')->group(function () {
            ...
            Route::get('reports/spares_available', 'ReportController@AparesAvailable')->name('reports.spares_available');
            ...
            Route::get('/total_equipment_expenditure/sum', 'ReportController@sumTotalEquipmentExpenditure')->name('total_equipment_expenditure.sum');
