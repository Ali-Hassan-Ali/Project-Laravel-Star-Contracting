...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard_admin.users.index', compact('users'));

    } //end of index

    public function create()
    {
        return view('dashboard_admin.users.create');
    ...
    {
        return view('dashboard_admin.users.edit', compact('user'));
    ...
    public function destroy(User $user)
    {
        ...
        try {
            ...
            return redirect()->route('dashboard_admin.users.index');
