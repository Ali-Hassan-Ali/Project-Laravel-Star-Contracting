...
class AverageExpenditureController extends Controller
{
    public function index()
    {
        ...
        return view('admin.charts.average_expenditure.index', compact('citys', 'equipments'));
    ...
    public function Chart()
    {
        ...
        return view('admin.charts.average_expenditure._chart', compact('fuels'));
