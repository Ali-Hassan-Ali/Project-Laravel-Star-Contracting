    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                <form action="{{ route('dashboard.admin.users.index') }}" method="get">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            @if (auth()->user()->hasPermission('users_create'))
                                {{-- <a href="{{ route('dashboard.admin.users.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('dashboard.add')</a> --}}
                            @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->hasPermission('users_update'))
                                            <a href="{{ route('dashboard.admin.users.edit', $user->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('dashboard.edit')</a>
                                        @else
