...
@section('title', __('dashboard.dashboard') .' - '. __('dashboard.vehicles') .' - '. __('dashboard.show'))
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('dashboard.vehicles')</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('dashboard.vehicles') <small>{{ $vehicles->total() }}</small></h3>

                    <form action="{{ route('dashboard.admin.vehicles.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('vehicles_create'))
                                    <a href="{{ route('dashboard.admin.vehicles.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('dashboard.add')</a>
                                @else
                    ...
                    @if ($vehicles->count() > 0)
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                @foreach ($vehicles as $index=>$apartment)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
