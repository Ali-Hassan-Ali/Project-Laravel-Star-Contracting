            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('admin.spares.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="number" name="freight_charges" class="form-control @error('freight_charges') is-invalid @enderror" value="{{ old('freight_charges') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="attachments[]" multiple autofocus class="form-control @error('attachments') is-invalid @enderror" value="{{ old('attachments') }}" required accept=".pdf,image/*,.doc,.docx">
                        @error('attachments')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
