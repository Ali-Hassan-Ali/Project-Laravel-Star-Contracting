                ...
                <form method="post" action="{{ route('admin.status.store') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="date" id="break_down_date" name="break_down_date" disabled
                                   {{ old('working_status') == 'Breakdown' ? '' : 'disabled' }} class="form-control @error('break_down_date') is-invalid @enderror" value="{{ old('break_down_date') }}" autofocus max="{{ date('Y-m-d', strtotime( now() )) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea disabled {{ old('working_status') == 'Breakdown' ? '' : 'disabled' }} id="break_down_description" 
