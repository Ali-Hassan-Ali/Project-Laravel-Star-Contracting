            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('admin.status.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="working_status" class="form-control select2" required>
                            ...
                            @foreach ($status as $statu)
                                <option value="{{ $statu }}" {{ $statu == old('working_status') ? 'selected' : '' }}>@lang('site.' . $statu)</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="as_of" class="form-control @error('as_of') is-invalid @enderror" value="{{ old('as_of') }}" required autofocus>
                        @error('as_of')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="break_down_date" class="form-control @error('break_down_date') is-invalid @enderror" value="{{ old('break_down_date') }}" required autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="break_down_duration" class="form-control @error('break_down_duration') is-invalid @enderror" value="{{ old('break_down_duration') }}" required autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="hours_worked" class="form-control @error('hours_worked') is-invalid @enderror" value="{{ old('hours_worked') }}" required autofocus>
                        @error('hours_worked')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
