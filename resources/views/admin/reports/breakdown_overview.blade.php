                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <select class="form-control report-search col-3 select2-tags-false equipment-city" id="report-city">
        ...
        let dataTable = $('#breakdown_overview-table').DataTable({
            ...
            footerCallback: function (row, data, start, end, display) {
                ...
                if (total == 0) {
                    ...
                    $('.average-min').html('Average Breakdown Duration ' + $.number(sum, 2) + ' Days');
                }
