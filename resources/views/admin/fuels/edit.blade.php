                ...
                <form method="post" action="{{ route('admin.fuels.update', $fuel->id) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group @error('equipment_id') custom-select @enderror col-6">
                            ...
                            <select name="equipment_id" id="equipment-man" class="form-control equipment select2" required>
                                <option value="" selected disabled>@lang('site.choose') @lang('equipments.equipments')</option>
                                @foreach ($equipments as $equipment)
                                    <option value="{{ $equipment->id }}" data-type="{{ $equipment->spec->name }}" {{ $equipment->id == old('equipment_id', $fuel->equipment_id) ? 'selected' : '' }}>{{ $equipment->name .' '. $equipment->make .' '. $equipment->plate_no }}</option>
                                @endforeach
                            </select>
                            @error('equipment_id')
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="project" class="form-control @error('project') is-invalid @enderror" value="{{ old('project', $fuel->project) }}" required autofocus>
                            @error('project')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
...
{{--                        </div>--}}
                        ...
                        <div class="form-group col-6">
                            ...
                            <input {{ $fuel->equipment->spec->name == 'heavyweight' ? 'disabled' : '' }} type="number" id="last_mileage_reading" name="last_mileage_reading" class="form-control @error('last_mileage_reading') is-invalid @enderror" value="{{ old('last_mileage_reading', $fuel->last_mileage_reading) }}" required autofocus>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input {{ $fuel->equipment->spec->name == 'heavyweight' ? 'disabled' : '' }} type="number" id="current_mileage_reading" name="current_mileage_reading" class="form-control @error('current_mileage_reading') is-invalid @enderror" value="{{ old('current_mileage_reading', $fuel->current_mileage_reading) }}" required autofocus>
                    ...
                    <input type="text" name="hours_worked_weekly" id="hours_worked_weekly-hidden" hidden>
