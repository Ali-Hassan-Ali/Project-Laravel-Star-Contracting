                ...
                <form method="post" action="{{ route('admin.equipments.update', $equipment->id) }}">
                    ...
                    <div class="form-group @error('equipments') custom-select @enderror">
                        ...
                        <select name="name" class="form-control select2" required>
                            ...
                            @foreach ($equ as $equs)
                                <option value="{{ $equs->name }}" {{ $equs->name == old('equipment', $equipment->name) ? 'selected' : '' }}>{{ $equs->name }}</option>
                            @endforeach
                        </select>
                        @error('equipment')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="plate_no" class="form-control @error('plate_no') custom-select @enderror" value="{{ $equipment->plate_no }}" required autofocus>
                        @error('plate_no')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="engine_no" class="form-control @error('engine_no') custom-select @enderror" value="{{ old('engine_no', $equipment->engine_no) }}" required autofocus>
                        @error('engine_no')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="test" name="rental_cost_basis" class="form-control @error('rental_cost_basis') custom-select @enderror" value="{{ old('rental_cost_basis', $equipment->rental_cost_basis) }}" autofocus>
                    ...
                    <div class="form-group @error('operator') custom-select @enderror">
                        ...
                        <select name="operator" class="form-control select2" required>
                            ...
                            @foreach ($operators as $operator)
                                <option value="{{ $operator->name }}" {{ $operator->name == old('operator', $equipment->operator) ? 'selected' : '' }}>{{ $rental->name }}</option>
                            @endforeach
                        </select>
                        @error('operator')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="driver_salary" class="form-control @error('driver_salary') custom-select @enderror" value="{{ old('driver_salary', $equipment->driver_salary) }}" required autofocus>
                        @error('driver_salary')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group @error('responsible_person') custom-select @enderror">
                        ...
                        <select name="responsible_person" class="form-control select2" required>
                            ...
                            @foreach ($responsible_person as $responsible)
                                <option value="{{ $responsible->name }}" {{ $responsible->name == old('responsible_person', $equipment->responsible_person) ? 'selected' : '' }}>{{ $responsible->name }}</option>
                            @endforeach
                        </select>
