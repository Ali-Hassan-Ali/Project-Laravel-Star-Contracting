                ...
                <form method="post" action="{{ route('admin.equipments.update', $equipment->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <select name="rental_basis" {{ old('owner_ship', $equipment->owner_ship) != 'Rented' ? 'disabled' : '' }} id="rental-basis" class="form-control select2-tags-false">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="number" name="rental_cost_basis" {{ old('owner_ship', $equipment->owner_ship) != 'Rented' ? 'disabled' : '' }} id="rental-cost-basis" class="form-control @error('rental_cost_basis') custom-select @enderror" value="{{ old('rental_cost_basis', $equipment->rental_cost_basis) }}" autofocus>
                        ...
                        <div class="form-group col-6">
                            ...
                            <select name="operator" {{ old('owner_ship', $equipment->owner_ship) == 'Rented' ? 'disabled' : '' }} id="operator" class="form-control select2" required>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" {{ old('owner_ship', $equipment->owner_ship) == 'Rented' ? 'disabled' : '' }} id="driver-salary" name="driver_salary" class="form-control @error('driver_salary') custom-select @enderror" value="{{ old('driver_salary', $equipment->driver_salary) }}" required autofocus>
                            @error('driver_salary')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group">
                        <label>@lang('insurances.claim_attachments') <span class="text-dark small" style="text-transform: none;" id="rented-attachments"></span></label>
