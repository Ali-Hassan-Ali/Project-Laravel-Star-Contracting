                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="number" {{ old('owner_ship') == 'Rented' ? 'disabled' : '' }} 
                                                     {{ old('operator') != 'Driver' ? 'disabled' : '' }} id="driver-salary" name="driver_salary" class="form-control @error('driver_salary') custom-select @enderror" value="{{ old('driver_salary', 0) }}" required autofocus>
                                @error('driver_salary')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
