                ...
                <form method="post" action="{{ route('admin.equipments.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="plate_no" class="form-control @error('plate_no') custom-select @enderror" value="{{ old('plate_no') }}" autofocus>
                        </div>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="serial_no" class="form-control @error('serial_no') custom-select @enderror" value="{{ old('serial_no') }}" autofocus>
                            @error('serial_no')
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="date" name="registration_date" id="registration-date" class="form-control @error('registration_date') custom-select @enderror" value="{{ old('registration_date') }}" autofocus max="{{ date('Y-m-d', strtotime( now() )) }}">
                        ...
                        <div class="form-group col-6">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="number" {{ old('owner_ship') == 'Rented' ? 'disabled' : '' }} id="driver-salary" name="driver_salary" class="form-control @error('driver_salary') custom-select @enderror" value="{{ old('driver_salary', 0) }}" required autofocus>
                                @error('driver_salary')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <select name="project_allocated_to[]" {{ old('allocated_to') == 'Project' ? '' : 'disabled' }} multiple id="project-allocated-to" class="form-control select2">
                                ...
                                @foreach ($project_allocated_to as $project)
                                    <option value="{{ $project->name }}" {{ $project->name == old('project_allocated_to') ? 'selected' : '' }}
                                        {{ in_array(ucwords($project->name), old('project_allocated_to', json_decode(ucwords(old('project_allocated_to'))) ?? [])) ? 'selected' : '' }}>
                                        {{ $project->name }}
                                    </option>
                                @endforeach
                            </select>
