                ...
                <form method="post" action="{{ route('admin.maintenances.update', $maintenance->id) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="date" name="actual_service_date" class="form-control @error('actual_service_date') is-invalid @enderror" value="{{ old('insurance_start_date', $maintenance->actual_service_date ? date('Y-m-d', strtotime($maintenance->actual_service_date)) : '') }}" required autofocus max="{{ date('Y-m-d', strtotime( now() )) }}">
