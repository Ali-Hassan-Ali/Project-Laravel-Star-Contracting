                ...
                <form method="post" action="{{ route('admin.maintenances.update', $maintenance->id) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="date" disabled name="next_service_date" id="next_service_date" class="form-control @error('next_service_date') is-invalid @enderror" value="{{ old('insurance_start_date', $maintenance->next_service_date ? date('Y-m-d', strtotime($maintenance->next_service_date)) : '') }}" required autofocus max="{{ date('Y-m-d', strtotime( now() )) }}">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="number" name="last_service_km" id="last_service_km" class="form-control @error('last_service_km') is-invalid @enderror" value="{{ old('last_service_km', $maintenance->last_service_km) }}" required autofocus>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="number" name="next_service_dueon_km" disabled id="next_service_dueon_km" class="form-control @error('next_service_dueon_km') is-invalid @enderror" value="{{ old('next_service_dueon_km', $maintenance->next_service_dueon_km) }}" required autofocus>
                        ...
                        <input type="number" name="next_service_dueon_km" id="next_service_dueon_km_hidden" hidden value="{{ old('next_service_dueon_km', $maintenance->next_service_dueon_km) }}" hidden>
                    ...
                    <div class="form-group ml-3">
                        <div class="form-check form-switch">
                          <input class="form-check-input" id="scheduled" type="checkbox" name="scheduled" value="{{ old('scheduled', '1') }}" {{ old('scheduled', $maintenance->scheduled) == '0' ? '' : 'checked' }}>
                    ...
                    <div class="form-group @error('non_scheduled') custom-select @enderror">
                        ...
                        <select {{ old('scheduled', $maintenance->scheduled) == '1' ? 'disabled' : '' }} name="non_scheduled" id="non-scheduled" class="form-control select2-tags-false" required>
